...
export function VariantSelector() {
  ...
  return (
    <div className="absolute bottom-sp-8 left-1/2 -translate-x-1/2 z-50 flex items-center gap-sp-4 bg-surface/80 backdrop-blur-md p-sp-3 rounded-full border border-border shadow-2xl pointer-events-auto">
        ...
        return (
          <button
            ...
            className={`w-10 h-10 rounded-full transition-all duration-300 border-2 ${
              isActive ? 'scale-110 border-text-primary shadow-[0_0_15px_rgba(255,255,255,0.3)]' : 'border-transparent hover:scale-105 opacity-80 hover:opacity-100'
            }`}
